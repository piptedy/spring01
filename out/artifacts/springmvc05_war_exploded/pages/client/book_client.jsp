    ...
    <script type="text/javascript">
        $(function () {
            $("#btnId").click(function () {
                ...
                location = "BookClientServlet?method=getPageByNo&pageNo=" +input_pageNo;
            })

          $(".uni").click(function () {
            var bookId = $(this).attr("id");
            location = "CartServlet?method=addBookToCart&id="+bookId;
          })
        })
      ...
      <div class="topbar">
        <div class="w">
          ...
          <div class="topbar-right">
            ...
            <a href="BookServlet?method=getPageByNo&pageNo=1" class="admin">后台管理</a>
          </div>
<!--          登录后风格-->
<!--          <div class="topbar-right">-->
          ...
          <div class="list">
            ...
            <div class="list-content">
              ...
              <div class="list-item">
                ...
                <p>销量:${book.sales}</p>
                <p>库存:${book.stock}</p>
                <button id="${book.id}" class="uni">加入购物车</button>
              </div>
                </c:forEach>
            ...
            <div class="list-footer">
                <a class="footer-right" href="BookClientServlet?method=getPageByNo&pageNo=1">首页</a>
                <c:if test="${requestScope.page.pageNo>1}">
                    <a class="footer-right" href="BookClientServlet?method=getPageByNo&pageNo=${requestScope.page.pageNo-1}">上一页</a>
                </c:if>
              ...
              <c:choose>
                ...
                <ul>
                  <c:forEach var="num" step="1" begin="${begin}" end="${end}">
                    <c:if test="${num==requestScope.page.pageNo}">
                      <li class="active"><a href="BookClientServlet?method=getPageByNo&pageNo=${num}">${num}</a></li>
<%--                      <li class="active">${num}</li>--%>
                    </c:if>
                    <c:if test="${num!=requestScope.page.pageNo}">
                      <li ><a href="BookClientServlet?method=getPageByNo&pageNo=${num}">${num}</a></li>
<%--                      <li >${num}</li>--%>
                    </c:if>
...
<%--                  <li class="active">1</li>--%>
                ...
                <c:if test="${requestScope.page.pageNo<requestScope.page.totalPageNo}">
                    <a class="footer-right" href="BookClientServlet?method=getPageByNo&pageNo=${requestScope.page.pageNo+1}">下一页</a>
                </c:if>

                <a class="footer-right" href="BookClientServlet?method=getPageByNo&pageNo=${requestScope.page.totalPageNo}">末页</a>
