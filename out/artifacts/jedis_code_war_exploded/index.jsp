...
$(function(){
	$("#sendCode").click( function () {
		   ...
		   $.post("${pageContext.request.contextPath}/SendCodeServlet",$("#codeform").serialize(),function(data){
	    	 if(data=="true"){
	    		 t=120;
	    		 clearInterval(interval);
	...
	$("#verifyCode").click( function () {
		   ...
		   $.post("${pageContext.request.contextPath}/CheckCodeServlet",$("#codeform").serialize(),function(data){
	    	 if(data=="true"){
